			...
			<Row>
				<Col sm={{ size: '10', offset: '1' }} md={{ size: '6', offset: '3' }}>
					...
					<p className='home__stack'>
						...
						support for tablets and iPads is in beta.
					</p>
					<p className='home__stack'>Watch the video above for
						a walkthrough by Mime's creators.
					</p>
					<p className='home__stack'>  View the codebase on <a href='https://github.com/mime-dream-team/mime-frontend'>GitHub</a>.
					</p>
				</Col>
			</Row>
		</Container>
